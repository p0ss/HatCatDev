...
- **Total Lenses**: 5619 (all AI safety concepts removed)
- **Created**: 2025-11-17
- **Updated**: 2025-11-17
...
- **layer0**: 14 lenses (14/14 successful)
- **layer1**: 276 lenses (276/276 successful)
- **layer2**: 1070 lenses (974/1070 successful)
- **layer3**: 1011 lenses (1011/1011 successful)
- **layer4**: 3278 lenses (3278/3278 successful)
- **layer5**: 26 lenses (26/26 successful)
...
# Load lens
lens_path = Path('lens_packs/gemma-3-4b-pt_sumo-wordnet-v2/hierarchy/Animal_classifier.pt')
