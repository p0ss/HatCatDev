...
- **layer0**: 10 lenses (10/10 successful)
- **layer1**: 257 lenses (257/257 successful)
- **layer2**: 1093 lenses (1093/1093 successful)
- **layer3**: 1027 lenses (1027/1027 successful)
- **layer4**: 3271 lenses (665/3271 successful)
- **layer5**: 10 lenses (10/10 successful)
...
# Load lens
lens_path = Path('concept_packs/gemma-3-4b-pt_sumo-wordnet-v3/hierarchy/Animal_classifier.pt')
