#!/usr/bin/env python3
"""
Mini validation: Can our probe pipeline learn implicature concepts?
...
def run_mini_validation(
    ...
    print("=" * 70)
    print("IMPLICATURE PROBE MINI-VALIDATION (v2)")
    print("=" * 70)
