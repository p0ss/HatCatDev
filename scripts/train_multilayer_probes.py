#!/usr/bin/env python3
"""
Train activation probes for multi-layer temporal monitoring.

This trains a focused set of concepts for the multi-layer lead-lag analysis.
We train each probe once at its "natural" layer, then use it to monitor
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train multi-layer monitoring probes"
    )
    ...
    parser.add_argument('--output-dir', type=str,
                        default='probe_packs/multilayer_monitoring')
    ...
    print("=" * 80)
    print("MULTI-LAYER MONITORING PROBE TRAINING")
    print("=" * 80)
    print()
    ...
    for layer_idx, concepts in sorted(CONCEPT_SUITE.items()):
        ...
        # Train activation probes only (no text probes for this task)
        train_concept_classifiers_adaptive(
            ...
            train_text_probes=False,  # Only activation probes
    ...
    print("=" * 80)
    print()
    print(f"Trained {total_concepts} probes")
