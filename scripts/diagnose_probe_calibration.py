#!/usr/bin/env python3
"""
Diagnose probe calibration by testing on diverse prompts.

Tests whether probes like PostalPlace fire broadly (poor calibration)
...
def diagnose_calibration():
    """Test probe calibration across diverse prompts"""
    ...
    print("\n" + "=" * 80)
    print("PROBE CALIBRATION DIAGNOSIS")
    print("=" * 80)
    print("\nTesting key probes across semantic domains:")
