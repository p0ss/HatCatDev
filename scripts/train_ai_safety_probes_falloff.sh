#!/usr/bin/env bash
#
# Train AI safety probes with falloff validation method
#
...
# Output directory
OUTPUT_DIR="results/ai_safety_probes_falloff"
...
echo "=================================="
echo "AI Safety Probe Training (Falloff)"
echo "=================================="
...
echo
echo "Next steps:"
echo "  1. Verify probe calibration in ${OUTPUT_DIR}"
echo "  2. Compare with behavioral training results (when available)"
echo "  3. Create v4 probe pack merging SUMO + AI safety probes"
echo
