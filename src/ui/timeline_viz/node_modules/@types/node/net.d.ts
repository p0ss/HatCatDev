...
declare module "net" {
    ...
    class Socket extends stream.Duplex {
         ...
         * delay before the first keepalive lens is sent on an idle socket.
         *
         * Set `initialDelay` (in milliseconds) to set the delay between the last
         * data packet received and the first keepalive lens. Setting `0` for`initialDelay` will leave the value unchanged from the default
         * (or previous) setting.
         *
    ...
    interface ServerOpts {
        ...
        keepAlive?: boolean | undefined;
        /**
         * If set to a positive number, it sets the initial delay before the first keepalive lens is sent on an idle socket.
         * @default 0
         * @since v16.5.0
         */
        keepAliveInitialDelay?: number | undefined;
