...
- **SPLIT** `Agreement`: Concept has 26 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
- **SPLIT** `AIGrowth`: Concept has 23 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
- **SPLIT** `Ambulating`: Concept has 10 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
- **SPLIT** `AngleMeasure`: Concept has 25 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
- **SPLIT** `AnimalShell`: Concept has 16 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
- **SPLIT** `Article`: Concept has 15 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
- **SPLIT** `ArtificialIntelligence`: Concept has 30 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
- **SPLIT** `AttachingDevice`: Concept has 10 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
- **SPLIT** `Beverage`: Concept has 50 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
- **SPLIT** `BiologicalAttribute`: Concept has 50 synsets indicating polysemy. Splitting into sense-specific probes will improve activa...
