Yeah, ok, that changes the game quite a bit.
If the text and the vis *must* live in the **same physical space** and line up, then we basically can’t treat the text as “someone else’s DOM” and overlay a separate viz next to it.
